    ...
    const services = [
        {
            ...
            path: '/properties?status=For Sale',
            icon: (
        ...
        },
        {
            ...
            path: '/properties?status=For Rent',
            icon: (
                <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            path: '/contact?service=management',
            icon: (
                <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {services.map((service) => (
                        <Link
                            ...
                            className="block"
                        >
                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:transform hover:-translate-y-1 text-center h-full cursor-pointer border border-transparent hover:border-primary">
